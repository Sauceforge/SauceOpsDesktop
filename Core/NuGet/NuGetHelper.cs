...
namespace SauceOps.Core.NuGet {
    public class NuGetHelper {
        ...
        //    var packages = repo.FindPackagesById(SauceOps.CoreConstants.PRODUCTNAME).ToList();
        ...
        //        if (packageReference.Id.Equals(SauceOps.CoreConstants.PRODUCTNAME)) {
